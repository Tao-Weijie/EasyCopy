bl_info = {
    ...
    "version": (0, 1, 0),
    "blender": (4, 5, 0),
    "location": "View3D > Sidebar > EasyCopy",
...
class EasyCopyPreferences(bpy.types.AddonPreferences):
    ...
    copy_key: bpy.props.StringProperty(
        name="Key",
        description="Key for Copy Shortcut",
        default='C',
    ...
    paste_key: bpy.props.StringProperty(
        name="Key",
        description="Key for Paste Shortcut",
        default='V',
        update=update_keymaps
    )
...
class BlenderPaste(bpy.types.Operator):
    ...
    bl_idname = "object.paste_from_clipboard"
...
def register():
    bpy.utils.register_class(EasyCopyPreferences)
    bpy.utils.register_class(BlenderCopy)
    bpy.utils.register_class(BlenderPaste)
...
def unregister():
    bpy.utils.unregister_class(EasyCopyPreferences)
    bpy.utils.unregister_class(BlenderCopy)
    bpy.utils.unregister_class(BlenderPaste)
